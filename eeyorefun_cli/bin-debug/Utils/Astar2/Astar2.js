...
var AStar2 = (function () {
    ...
    AStar2.prototype.search = function () {
        ...
        while (!this.isEnd) {
            ...
            var _tempList = [];
            for (var a = startX; a < endX; a++) {
                _tempList.push(new Point(a, node.y));
            }
            for (var b = startY; b < endY; b++) {
            ...
            for (var i = startX; i <= endX; i++) {
                for (var j = startY; j <= endY; j++) {
                    ...
                    var testNode = this._grid.getNode(i, j);
                    ...
                    var h = this._heuristic(testNode);
                    var f = g + h;
    ...
    AStar2.prototype.manhattan2 = function (node) {
